...
<div class="col-sm-6">
	<form enctype="multipart/form-data" method="POST" action="">
		<div class="form-group">
	  	...
	  	<div class="form-group">
		    <label for="roll">Codigo de Matrícula</label>
	  	...
	  	<div class="form-group">
		    <label for="class">Nivel Formacion</label>
		    <select name="class" class="form-control" id="class" required="" value="">
		    	<option>Seleccionar</option>
		    	<option value="Nivel Basico" <?= $row['class']=='Nivel Basico'? 'selected':'' ?>> Nivel Basico</option>
		    	<option value="Nivel Intermedio" <?= $row['class']=='Nivel Intermedio'? 'selected':'' ?>>Nivel Intermedio</option>
		    	<option value="Nivel Avanzado" <?= $row['class']=='Nivel Avanzado'? 'selected':'' ?>>Nivel Avanzado</option>
		    </select>
	  	</div>
	  	<div class="form-group">
